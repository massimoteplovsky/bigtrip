...
const createAddEditTripTemplate = () => {
  return (
...
const createTripEventContainer = () => {
  return (
    `<ul class="trip-days">
...
render(tripEventsElement, createAddEditTripTemplate());
render(tripEventsElement, createTripEventContainer());

const tripItemList = tripEventsElement.querySelector(`.trip-events__list`);
